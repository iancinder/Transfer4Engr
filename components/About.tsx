        ...
        <div className="grid items-start gap-12 lg:grid-cols-[1fr_1.2fr] lg:gap-16">
          ...
          <Reveal delay={0.12}>
            <div className="space-y-5 text-base leading-relaxed text-ink-700">
              ...
              <p>
                I didn't get into UT on accident - I probably went to at least 20 different
              ...
              <p>
                ...
                who knows where the gaps lie, because I stood where you stood not even a year ago.
              </p>
              <p>
